...
-   **Parallel Processing**: Analyzes logical components in parallel for faster execution, with dynamic depth based on importance. Concurrency is limited to prevent API rate limiting (default: 3 parallel agents).
